...
export default function PostPage() {
  ...
  return <main className="p-3 flex flex-col max-w-6xl mx-auto min-h-screen ">
    <h1 className="text-3xl mt-10 p-3 text-center font-serif max-w-2xl mx-auto lg:text-4xl">{posts && posts.title}</h1>
    ...
    <img src={posts && posts.image} alt={posts && posts.title} className="self-center mt-10 max-w-3xl p-3 max-h-[600px] w-full object-contain" />
    <div className="flex justify-between p-3 border-b border-slate-300 mx-auto w-full max-w-2xl text-xs">
      ...
      <span className="italic">{posts && (posts.content.length/1000).toFixed(0)}, mins read</span>
    </div>
    <div className="p-3 max-w-2xl mx-auto w-full post-content" dangerouslySetInnerHTML={{ __html: posts && posts.content }}>
